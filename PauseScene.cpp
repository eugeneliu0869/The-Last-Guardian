...
PauseScene::PauseScene()
{
    ...
    sample = al_load_sample("./sound/PauseScene/SwitchSound.ogg");
    ...
    sample = al_load_sample("./sound/PauseScene/EnterSound.ogg");
...
PauseScene::SceneInit()
{
    ...
    continue_label_y = title_y + title_height + label_difference * 8;

    setting_label_x = (window_width - setting_label_width)/2;
    setting_label_y = continue_label_y + continue_label_height + label_difference * 5;

    exit_label_x = (window_width - exit_label_width)/2;
    exit_label_y = setting_label_y + setting_label_height + label_difference * 5;
