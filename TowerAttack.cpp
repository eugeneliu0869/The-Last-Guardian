...
TowerAttack::TowerAttack(Circle* created_circle, Circle* target_circle, int _harm_point, int _velocity, ALLEGRO_BITMAP* _attack_image)
    : harm_point(_harm_point), attack_velocity(_velocity), attack_image(_attack_image)
{
...
void TowerAttack::Draw()
{
    al_draw_bitmap(attack_image, pos_x - circle->r, pos_y - circle->r, 0);
